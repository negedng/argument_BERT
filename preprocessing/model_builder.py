...
def select_FFNN_features(dataset, shared_features=True,
    ...
    if shared_feature_list == None:
        ...
        shared_feature_list = shared_feature_list.drop(['arg1', 'arg2', 'originalArg1', 'originalArg2', 'argumentationID', 'label', 'originalLabel', 'bertArg1', 'bertArg2', 'bertOriginalArg1', 'bertOriginalArg2', 'vector1', 'vector2', 'pos1', 'pos2', 'bertVector1', 'bertVector2'], errors='ignore')
